...
Libraries are shareable across libraries and applications. They can be imported from `@papa-noel-secreto/mylib`.
...
Run `ng build my-app` to build the project. The build artifacts will be stored in the `dist/` directory. Use the
